...
def run_backtest():
    ...
    print("--- 60-Day 15-Min Reversal Confirmation Backtest ---")
    print(f"Rules: Price > 50-SMA | RSI < 30 recently | Current Candle GREEN (Close > Open)")
    ...
    for sym in portfolio:
        try:
            ...
            # Create a flag if RSI was < 30 in the last 3 candles
            df['RSI_Oversold_Recently'] = (df['RSI_14'] < 30).rolling(window=3).max()
            
            # Is Current Candle Green?
